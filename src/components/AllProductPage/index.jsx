                        ...
                        >
                          <a rel="noopener noreferrer">
                            <div className="cursor-pointer w-full relative  ">
                              ...
                              <div className="w-[82px] transition-all duration-300 ease-in-out group-hover:h-4 h-[2px] secondary-bg absolute left-0 bottom-0 z-10"></div>
                            </div>
                          </a>
                        </Link>
                      </div>
                  ...
                  <div className="flex space-x-3 items-center">
                    ...
                    <button
                      ...
                      className={`hover:text-qgreen w-6 h-6 ${
                        cardViewStyle === "col" ? "primary-text" : "text-qgray"
                      }`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <button
                      ...
                      type="button"
                      className={`hover:text-qgreen w-6 h-6 ${
                        cardViewStyle === "row" ? "primary-text" : "text-qgray"
                      }`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
