      ...
      <Layout childrenClasses="pt-0 pb-0">
        <>
          <div className="single-product-wrapper w-full bg-white">
            ...
            <div
              className="product-des-wrapper w-full relative pb-[60px] bg-[#FFFCF7]"
              ref={reviewElement}
            >
              <div className="tab-buttons w-full mb-10 mt-5 sm:mt-0">
                <div className="container-x mx-auto">
                  <ul className="flex space-x-12 ">
                    <li>
                      <span
                        onClick={() => setTab("des")}
                        className={`py-[15px] sm:text-[15px] text-sm sm:block border-b font-medium cursor-pointer relative z-10 ${
                          tab === "des"
                            ? "border-qgreen text-qblack "
                ...
                <div className="w-full h-[1px] bg-[#CBECD9] absolute left-0 sm:top-[50px] top-[36px]"></div>
              </div>
            ...
            {relatedProducts.length > 0 && (
              <div className="related-product w-full relative">
                <div
                  className="w-full h-[765px] absolute left-0 top-0"
                  style={{
                    backgroundImage: `url(/assets/images/related-product-bg.png)`,
                  ...
                  <div className="w-full mb-[40px]">
                    ...
                    <textarea
                      ...
                      className={`w-full focus:ring-0 rounded focus:outline-none py-3 px-4 border  placeholder:text-sm text-sm ${
                        reportErrors ? "border-qred" : "border-[#CBECD9]"
                      }`}
