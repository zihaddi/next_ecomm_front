      ...
      <div className="mt-[40px] w-full flex justify-center">
        ...
        >
          <a rel="noopener noreferrer">
            <div className="w-[300px] rounded w-full h-[50px] secondary-bg flex items-center justify-center">
              <span
                className="text-qblack font-semibold"
                style={{ fontSize: "16px" }}
              >
                {langCntnt && langCntnt.View_Shop}
              </span>
            </div>
          </a>
        </Link>
