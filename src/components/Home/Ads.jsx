          ...
          <div className="w-full h-full flex fixed left-0 top-0 justify-center z-40 items-center ">
            ...
            >
              ...
              <div className="md:w-[415px] w-full h-[54px] sm:flex mt-8">
                <div className="flex-1 bg-white pl-4 mb-2 md:mb-0 flex space-x-2 items-center h-full focus-within:text-qgreen text-qblack overflow-hidden rounded md:rounded-r-none">
                  <span>
                    <svg
                      width="17"
                      height="15"
                ...
                <button
                  ...
                  type="button"
                  className="w-[120px] h-full bg-qgreen text-white text-sm font-600 rounded md:rounded-r md:rounded-l-none"
                >
