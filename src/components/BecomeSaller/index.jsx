...
function BecomeSaller() {
  ...
  return (
    <div className="become-saller-wrapper w-full bg-white">
      ...
      <div className="content-wrapper w-full pb-10">
            ...
            <div className="flex xl:flex-row flex-col-reverse xl:space-x-11">
              <div className="xl:w-[824px]">
                ...
                <div className="input-area mb-10">
                  ...
                  {/*    Country**/}
                  {/*  </h6>*/}
                  {/*  <div className="w-full h-[50px] border border-[#CBECD9] px-5 flex justify-between items-center mb-2">*/}
                  ...
                  <div className="signin-area mb-3">
                    <div className="flex justify-center">
                      <button
                        ...
                        type="button"
                        className="black-btn rounded disabled:bg-opacity-60 disabled:cursor-not-allowed  text-sm text-white w-[490px] h-[50px] font-semibold flex justify-center bg-purple items-center"
                      >
                        <span>
                  ...
                  <div className="flex justify-center">
                    <div className="w-full relative">
                      ...
                      <div
                        ...
                        className="w-[32px] h-[32px] absolute -bottom-4 right-4 primary-bg rounded-full cursor-pointer"
                      >
                        <svg
                          width="32"
                          height="32"
