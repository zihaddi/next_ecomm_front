...
export default function Blog({ details }) {
  ...
  return (
    <Layout childrenClasses="pt-0 pb-0">
      <div className="blog-page-wrapper w-full bg-white">
            ...
            <div className="blog-article lg:flex lg:space-x-[30px] pb-7 ">
                ...
                <div className="extra-content w-full">
                  ...
                  <div className="comment-area w-full mt-8">
                    <div className="w-full sm:flex justify-between items-center mb-8">
                      ...
                      {/*  <span className="text-base text-qgraytwo hover:text-qgreen">*/}
                      {/*    #Technology*/}
                      {/*  </span>*/}
                      {/*  <span className="text-base text-qgraytwo hover:text-qgreen">*/}
                      {/*    #Agency*/}
                      ...
                      <div className="tags flex space-x-5 items-center">
                        ...
                        <div className="flex space-x-2.5 items-center">
                          ...
                          >
                            <span className="text-base cursor-pointer primary-text ">
                              <svg
                                width="35"
                                height="35"
                                viewBox="0 0 35 35"
              ...
              <div className="lg:w-[370px] w-full">
                ...
                >
                  ...
                  <div className="w-full h-[1px] bg-[#D6EEDD] mb-5"></div>
                  <div className="w-full h-[60px] rounded overflow-hidden relative">
                    <input
                      value={searchKey}
                      ...
                      type="text"
                      placeholder="Search"
                      className="w-full h-full bg-[#F3FAF5] focus:outline-none focus:ring-0 pl-5 pr-16 placeholder:text-qgraytwo"
                    />
                    <span className="absolute right-5 top-[17px] primary-text">
                      <svg
                        width="25"
                        height="25"
                        viewBox="0 0 25 25"
                ...
                >
                  <h1 className="text-[22px] text-qblack font-bold mb-5">
                    {langCntnt && langCntnt.Latest_Post}
                  </h1>
                  <div className="w-full h-[1px] bg-[#D6EEDD] mb-5"></div>
                    ...
                    {details.categories.length > 0 &&
                      details.categories.map((category) => (
                        ...
                        >
                          ...
                          >
                            <a>
                              <span className="text-base text-qgraytwo group-hover:text-qgreen cursor-pointer">
                                {category.name}
                              </span>
                            </a>
                          </Link>
                          {/*    <span className="text-base text-qgraytwo group-hover:text-qgreen">*/}
                          {/*  (6)*/}
                          {/*</span>*/}
                        </li>
                      ))}
                ...
                {/*      <span className="text-base bg-[#F9F3E9] hover:bg-qgreen text-[#9A9A9A] hover:text-qblack px-[14px] py-[6px] cursor-pointer mb-[5px]">*/}
                {/*        Agency*/}
                {/*      </span>*/}
                {/*      <span className="text-base bg-[#F9F3E9] hover:bg-qgreen text-[#9A9A9A] hover:text-qblack px-[14px] py-[6px] cursor-pointer mb-[5px]">*/}
                {/*        Creative*/}
                  ...
                  <div className="w-full h-full p-[30px] bg-black bg-opacity-75 flex flex-col justify-between">
                    <div>
                      <h1 className="text-[22px] text-white font-bold mb-5">
                        {langCntnt && langCntnt.Our_Newsletter}
                      </h1>
                      <div className="w-full h-[1px] bg-qgray-border mb-5"></div>
                      <p className="text-base text-white leading-[26px] line-clamp-2">
                        {langCntnt &&
                          langCntnt.Follow_our_newsletter_to_stay_updated_about_us}
                        .
                      </p>
                    </div>
                    <div>
