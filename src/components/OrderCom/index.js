          ...
          <div className="bg-white lg:p-10 p-3 rounded-xl">
            {resData && (
              <div id="printSection">
                <div className="sm:flex justify-between items-center mb-4">
                  ...
                  <div>
                    <button
                      onClick={print}
                      type="button"
                      className="w-[161px] h-[52px] rounded flex space-x-2.5 items-center justify-center bg-qgreen print:hidden mt-5 sm:mt-0"
                    >
                      <span>
                        <svg
                          width="27"
                ...
                <div className="relative w-full overflow-x-auto overflow-style-none overflow-hidden rounded border border-[#CBECD9] box-border mb-10">
              ...
              <div className="w-full review-form ">
                ...
                <div className="w-full mb-[30px]">
                  ...
                  <textarea
                    ...
                    cols="30"
                    rows="3"
                    className="w-full placeholder:text-sm focus:ring-0 rounded border border-[#CBECD9] focus:outline-none p-6"
                  ></textarea>
                </div>
